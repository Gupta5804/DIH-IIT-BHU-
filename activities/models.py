...
class Notification(models.Model):
    ...
    question = models.ForeignKey('lan_complain.Question', null=True, blank=True)
    answer = models.ForeignKey('lan_complain.Answer', null=True, blank=True)
    article = models.ForeignKey('enotices.Article', null=True, blank=True)
